...
export function TimelineDemo() {
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            />
            <div className=" bg-gradient-to-b from-gray-200/80 to-gray-500/80 rounded-lg object-cover h-30 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]">
              <div className="p-2 sm:p-8 flex flex-col items-start justify-center">
                <h2 className="text-black font-bold text-2xl sm:text-4xl leading-tight mb-3">
                  Event Registration Starts -
                </h2>
                <p className="text-neutral-900 font-medium sm:text-xl leading-snug">
                  The event registration starts from 23rd of December, All the Best!.
                </p>
              </div>
            </div>
            <Image
            ...
            <div className="bg-gradient-to-b from-gray-200/80 to-gray-500/80 rounded-lg object-cover h-30 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]">
              <div className="p-2 sm:p-8 flex flex-col items-start justify-center">
                ...
                <p className="text-neutral-900 font-medium sm:text-xl leading-snug">
                  The event registation closes on 13th of January, Start working ASAP.
                </p>
              </div>
            </div>
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-gradient-to-b from-gray-200/80 to-gray-500/80 rounded-lg object-cover h-30 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]">
              <div className="p-2 sm:p-8 flex flex-col items-start justify-center">
                <h2 className="mb-5 text-black font-bold text-2xl sm:text-4xl leading-tight">
                  Preliminary Round
                </h2>
                <p className="text-neutral-900 font-medium sm:text-xl leading-snug">
                  selection of problem statement and working on developement part, Let your creativity speak for you.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-b from-gray-200/80 to-gray-500/80 rounded-lg object-cover h-30 md:h-44 lg:h-60 w-full shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]">
              <div className="p-2 sm:p-8 flex flex-col items-start justify-center">
                ...
                <p className="text-neutral-900 font-medium sm:text-xl leading-snug">
                  Evaluation by judges working at multinational companies.
                </p>
              </div>
            </div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-200 text-lg sm:text-2xl mb-2 sm:mb-2">
          ...
          <p className="text-white dark:text-neutral-200 text-md md:text-xl font-normal">
            {/* Check out{" "} */}
            <a
  ...
  return (
    <div className="px-4 md:px-16 py-4 sm:py-10 lg:py-10">
      <div className="flex items-center justify-center">
        <h2 className="text-center inline-block bg-gradient-to-r from-gray-200 via-gray-600 to-gray-200  text-transparent bg-clip-text text-2xl md:text-6xl font-bold">
          EVENT TIMELINE
        </h2>
      </div>
      <Timeline data={data} />
